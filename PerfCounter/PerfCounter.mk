...
##
## Debug
ProjectName            :=PerfCounter
ConfigurationName      :=Debug
WorkspacePath          :=D:/Semper_Workspace
ProjectPath            :=D:/Semper_Workspace/PerfCounter
...
ObjectsFileList        :="PerfCounter.txt"
PCHCompileFlags        :=
...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)semper $(LibrarySwitch)pdh 
ArLibs                 :=  "semper" "pdh" 
...
Objects0=$(IntermediateDirectory)/src_perfcounter.c$(ObjectSuffix) 
...
$(OutputFile): $(IntermediateDirectory)/.d $(Objects) 
	...
	@echo rebuilt > "D:\Semper_Workspace/.build-debug/PerfCounter"
...
## Objects
##
$(IntermediateDirectory)/src_perfcounter.c$(ObjectSuffix): src/perfcounter.c 
	$(CC) $(SourceSwitch) "D:/Semper_Workspace/PerfCounter/src/perfcounter.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_perfcounter.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_perfcounter.c$(PreprocessSuffix): src/perfcounter.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_perfcounter.c$(PreprocessSuffix) src/perfcounter.c
