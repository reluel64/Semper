...
void string_fancy_init(object* o)
{
    if(o)
    {
        o->pv = zmalloc(sizeof(string_fancy_object));
        string_fancy_object* so = o->pv;
...
void string_fancy_reset(object* o)
{
...
int string_fancy_update(object* o)
{
    string_bind sb = { 0 };
    string_fancy_object* so = o->pv;
...
int string_fancy_render(object* o, cairo_t* cr)
{
    string_fancy_object* so = o->pv;
...
void string_fancy_destroy(object* o)
{
    if(o && o->pv)
    {
        string_fancy_object* so = o->pv;
